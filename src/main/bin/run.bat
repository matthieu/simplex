...
%JAVACMD% %SIMPLEX_JAVAOPTS% -Djava.util.logging.config.file="%SIMPLEX_HOME%/log/logging.properties" -cp "%LOCALCLASSPATH%" com.intalio.simplex.StandaloneServer "%SIMPLEX_HOME%"  %* 
goto end
